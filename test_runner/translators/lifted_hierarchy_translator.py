...
colored_hierarchy_translation_path = os.path.abspath("./test_runner/systems/colored_translation_hierarchy/main.py")
class LiftedHierarchyTranslator(TapaalTranslator):
    def __init__(self, sample_count: int, searches: list["TapaalColorSearcher"] = []) -> None:
        super().__init__("colored_hierarchy", sample_count, searches)
